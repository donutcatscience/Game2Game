...
public class BaseVariables : MonoBehaviour
{
    ...
    [HideInInspector] public Renderer rend;                             // renderer component
    ...
    void Start()
    {
        ...
        //skinRend = GetComponentInChildren<SkinnedMeshRenderer>();
        ...
        switch (minionType)
        {
            case MinionType.Melee:
                ...
                anim.runtimeAnimatorController = animCont[0];
                //meleeRadius = 4f;
                break;
            case MinionType.Healer:
                //rend.material.color = Color.red;
                anim.runtimeAnimatorController = animCont[1];
                //meleeRadius = 4f;
                break;
            case MinionType.Ranged:
                //rend.material.color = Color.blue;
                anim.runtimeAnimatorController = animCont[2];
                //meleeRadius = 16f;
                break;
            default:
                break;
