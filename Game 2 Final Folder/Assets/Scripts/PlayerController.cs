...
public class PlayerController : MonoBehaviour {
    ...
    void Start ()
    {
        ...
        waypointDir = 1;
        waypointDirection = WaypointDirection.pingpong;
    }
    ...
    void Update()
    {
        ...
        CalcPath(primaryPath, primaryTarget);                                                                                           // calculate primary path
        CalcPath(secondaryPath, secondaryTarget);                                                                                       // calculate secondary path
        agent.SetPath(primaryPath);                                                                                                     // set primary path

        primaryPathDist = PathDistance(primaryPath, Color.red, true);                                                                   // calculate primary path distance
        secondaryPathDist = PathDistance(secondaryPath, Color.blue, true);                                                              // calculate secondary path distance
    }
